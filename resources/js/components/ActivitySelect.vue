<template>
    <div class="input-group">
        <select name="activity_id" id="activity_id" class="form-control" v-model="activity" @change="updateActivity">
            ...
            <option v-for="activity in activities" :key="activity.id" :value="activity.id">{{ `${activity.activitytitle} held at ${activity.venue} on ${activity.startdate} to ${activity.enddate}` }}</option>
        </select>
